...
public class CantidadDePiezas extends JDialog {
	...
	public CantidadDePiezas(Principal principal, TiendaDeComputadoras t) {
		...
		String[] columnNamesPiezas = {"Pieza" ,"Cantidad"};
	...
	private void llenarTablaPiezas(DefaultTableModel modelPiezas) {
		...
		for (ComponenteOrdenador c : tienda.getComponentes()) {
			...
			modelPiezas.addRow(new Object[]{nombreCompleto, c.getCantDisponible()});
		}
	}
